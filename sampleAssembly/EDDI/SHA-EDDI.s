...
.LBB39_5:                               # %for.body44
	...
	l.ori	r16, r20, 0
	l.srli	r12, r4, 27
	l.xor	r20, r21, r24           # CFC
	l.slli	r13, r4, 5
	l.xor	r20, r20, r16           # CFC
	l.or	r12, r13, r12
	l.srli	r25, r17, 27
	l.add	r7, r12, r7
	l.slli	r26, r17, 5
...
# BB#0:                                 # %entry
	...
	l.addi	r3, r5, 28
	l.movhi	r16, hi(.Lsha_stream.file_data)
	l.ori	r17, r16, lo(.Lsha_stream.file_data)
	l.addi	r16, r18, 28
	l.sfne	r3, r16
	l.bf	.LBB41_4
	l.sw	-16(r2), r3
...
# BB#7:                                 # %entry
	...
	l.lwz	r3, -16(r2)
	l.movhi	r16, hi(.Lsha_stream.file_data+64)
	l.lwz	r5, -20(r2)
	l.ori	r17, r16, lo(.Lsha_stream.file_data+64)
	l.lwz	r16, 1652(r15)
	l.lwz	r18, 1648(r15)
# BB#8:                                 # %entry
	l.jal	memcpy
...
# BB#0:                                 # %entry
	...
	l.movhi	r16, hi(.L.str.9)
	l.ori	r16, r16, lo(.L.str.9)
# BB#3:                                 # %entry
	l.jal	printf_to_sim
	l.addi	r22, r9, 0              # in delay slot
                                        # CFC
