...
.LBB8_17:                               # %do.body98
	...
	l.movhi	r5, 64
	l.xor	r16, r21, r20
	l.movhi	r4, hi(.LJTI8_0)
	l.addi	r26, r0, 1
	l.ori	r4, r4, lo(.LJTI8_0)
	l.movhi	r18, 64
	l.slli	r12, r12, 2
	l.movhi	r17, hi(.LJTI8_0)
	l.add	r4, r12, r4
	l.ori	r17, r17, lo(.LJTI8_0)
	l.lwz	r4, 0(r4)
	l.slli	r25, r25, 2
	l.add	r17, r25, r17
	l.lwz	r17, 2548(r17)
...
.LBB8_42:                               # %do.body169
	...
	l.nop	0                       # in delay slot
.LBB8_43:                               # %do.body169
	l.movhi	r4, hi(.LJTI8_1)
	l.ori	r4, r4, lo(.LJTI8_1)
	l.slli	r5, r3, 2
	l.movhi	r17, hi(.LJTI8_1)
	l.add	r4, r5, r4
	l.ori	r17, r17, lo(.LJTI8_1)
	l.lwz	r4, 0(r4)
	l.slli	r18, r16, 2
	l.ori	r3, r12, 0
	l.add	r17, r18, r17
...
# BB#0:                                 # %entry
	...
	l.ori	r12, r3, lo(.LJTI33_0)
	l.movhi	r3, 0
	l.movhi	r16, hi(.LJTI33_0)
	l.ori	r25, r16, lo(.LJTI33_0)
	l.movhi	r16, 0
	l.sfne	r3, r16
	l.bf	.LBB33_235
	l.sw	-120(r2), r3
...
.LBB33_1:                               # %for.cond
                                        ...
                                        #           Child Loop BB33_40 Depth 5
                                        #           Child Loop BB33_31 Depth 5
                                        #     Child Loop BB33_116 Depth 2
                                        #     Child Loop BB33_129 Depth 2
                                        #     Child Loop BB33_132 Depth 2
                                        #     Child Loop BB33_118 Depth 2
                                        #     Child Loop BB33_162 Depth 2
                                        #     Child Loop BB33_192 Depth 2
                                        #     Child Loop BB33_206 Depth 2
                                        #     Child Loop BB33_225 Depth 2
	l.ori	r4, r13, 0
	l.ori	r17, r26, 0
.LBB33_2:                               # %while.cond
...
# BB#237:                               # %if.then6
	...
	l.bf	.LBB33_11
	l.nop	0                       # in delay slot
.LBB33_8:                               # %print_back_to_string.exit
	l.lwz	r3, -64(r2)
	l.lwz	r16, 2484(r15)
	l.j	.LBB33_9
	l.nop	0                       # in delay slot
...
# BB#242:                               # %while.body415
	...
	l.bf	.LBB33_162
	l.nop	0                       # in delay slot
.LBB33_165:                             # %while.end421.loopexit
                                        #   in Loop: Header=BB33_1 Depth=1
	l.lwz	r3, -108(r2)
	l.lwz	r4, -164(r2)
	l.sub	r3, r4, r3
...
# BB#243:                               # %while.end421
	...
	l.bf	.LBB33_170
	l.nop	0                       # in delay slot
.LBB33_169:                             # %print_back_to_string.exit819
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_170:                             # %do.end428
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#244:                               # %if.then434
	...
	l.bf	.LBB33_176
	l.nop	0                       # in delay slot
.LBB33_175:                             # %print_back_to_string.exit810
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_176:                             # %if.end438
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#245:                               # %if.then443
	...
	l.bf	.LBB33_182
	l.nop	0                       # in delay slot
.LBB33_181:                             # %print_back_to_string.exit801
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_182:                             # %if.end451
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#246:                               # %while.body471
	...
	l.bf	.LBB33_192
	l.nop	0                       # in delay slot
.LBB33_193:                             # %while.end477.loopexit
                                        #   in Loop: Header=BB33_1 Depth=1
	l.lwz	r3, -108(r2)
	l.lwz	r4, -148(r2)
	l.sub	r3, r4, r3
...
# BB#247:                               # %while.end477
	...
	l.bf	.LBB33_198
	l.nop	0                       # in delay slot
.LBB33_197:                             # %print_back_to_string.exit783
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_198:                             # %do.end484
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#248:                               # %while.body501
	...
	l.bf	.LBB33_206
	l.nop	0                       # in delay slot
.LBB33_207:                             # %while.end507.loopexit
                                        #   in Loop: Header=BB33_1 Depth=1
	l.lwz	r3, -128(r2)
	l.lwz	r4, -140(r2)
	l.sub	r3, r4, r3
...
# BB#249:                               # %while.end507
	...
	l.bf	.LBB33_212
	l.nop	0                       # in delay slot
.LBB33_211:                             # %print_back_to_string.exit765
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_212:                             # %do.end514
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#250:                               # %if.end517
	...
	l.bf	.LBB33_217
	l.nop	0                       # in delay slot
.LBB33_216:                             # %print_back_to_string.exit756
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_217:                             # %if.end521
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#251:                               # %while.body538
	...
	l.bf	.LBB33_225
	l.nop	0                       # in delay slot
.LBB33_226:                             # %while.end544.loopexit
                                        #   in Loop: Header=BB33_1 Depth=1
	l.lwz	r3, -108(r2)
	l.lwz	r4, -92(r2)
	l.sub	r3, r4, r3
...
# BB#252:                               # %while.end544
	...
	l.bf	.LBB33_231
	l.nop	0                       # in delay slot
.LBB33_230:                             # %print_back_to_string.exit738
	l.j	.LBB33_8
	l.nop	0                       # in delay slot
.LBB33_61:                              # %if.else131
                                        #   in Loop: Header=BB33_1 Depth=1
...
# BB#0:                                 # %entry
	...
	l.movhi	r16, hi(.L.str.5.8)
	l.ori	r16, r16, lo(.L.str.5.8)
# BB#3:                                 # %entry
	l.jal	printf_to_sim
	l.addi	r22, r9, 0              # in delay slot
                                        # CFC
