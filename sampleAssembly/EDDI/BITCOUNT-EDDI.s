...
.LBB14_17:                              # %do.body98
	...
	l.movhi	r5, 64
	l.xor	r16, r21, r20
	l.movhi	r4, hi(.LJTI14_0)
	l.addi	r26, r0, 1
	l.ori	r4, r4, lo(.LJTI14_0)
	l.movhi	r18, 64
	l.slli	r12, r12, 2
	l.movhi	r17, hi(.LJTI14_0)
	l.add	r4, r12, r4
	l.ori	r17, r17, lo(.LJTI14_0)
	l.lwz	r4, 0(r4)
	l.slli	r25, r25, 2
	l.add	r17, r25, r17
	l.lwz	r17, 3568(r17)
...
.LBB14_42:                              # %do.body169
	...
	l.nop	0                       # in delay slot
.LBB14_43:                              # %do.body169
	l.movhi	r4, hi(.LJTI14_1)
	l.ori	r4, r4, lo(.LJTI14_1)
	l.slli	r5, r3, 2
	l.movhi	r17, hi(.LJTI14_1)
	l.add	r4, r5, r4
	l.ori	r17, r17, lo(.LJTI14_1)
	l.lwz	r4, 0(r4)
	l.slli	r18, r16, 2
	l.ori	r3, r12, 0
	l.add	r17, r18, r17
...
# BB#0:                                 # %entry
	...
	l.ori	r12, r3, lo(.LJTI39_0)
	l.movhi	r3, 0
	l.movhi	r16, hi(.LJTI39_0)
	l.ori	r25, r16, lo(.LJTI39_0)
	l.movhi	r16, 0
	l.sfne	r3, r16
	l.bf	.LBB39_235
	l.sw	-120(r2), r3
...
.LBB39_1:                               # %for.cond
                                        ...
                                        #           Child Loop BB39_40 Depth 5
                                        #           Child Loop BB39_31 Depth 5
                                        ...
                                        #     Child Loop BB39_206 Depth 2
                                        #     Child Loop BB39_225 Depth 2
	l.ori	r4, r13, 0
	l.ori	r17, r26, 0
.LBB39_2:                               # %while.cond
...
# BB#237:                               # %if.then6
	...
	l.bf	.LBB39_11
	l.nop	0                       # in delay slot
.LBB39_8:                               # %print_back_to_string.exit
	l.lwz	r3, -64(r2)
	l.lwz	r16, 3504(r15)
	l.j	.LBB39_9
	l.nop	0                       # in delay slot
...
.LBB39_58:                              # %sw.bb123
	...
	l.movhi	r16, hi(.L.str.8)
	l.ori	r16, r16, lo(.L.str.8)
	l.sfne	r3, r16
	l.bf	.LBB39_235
	l.sw	-124(r2), r3
	l.sw	3444(r15), r16
...
# BB#242:                               # %while.body415
	...
	l.bf	.LBB39_162
	l.nop	0                       # in delay slot
.LBB39_165:                             # %while.end421.loopexit
                                        #   in Loop: Header=BB39_1 Depth=1
	l.lwz	r3, -108(r2)
	l.lwz	r4, -164(r2)
	l.sub	r3, r4, r3
...
# BB#243:                               # %while.end421
	...
	l.bf	.LBB39_170
	l.nop	0                       # in delay slot
.LBB39_169:                             # %print_back_to_string.exit819
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_170:                             # %do.end428
                                        #   in Loop: Header=BB39_1 Depth=1
...
# BB#244:                               # %if.then434
	...
	l.bf	.LBB39_176
	l.nop	0                       # in delay slot
.LBB39_175:                             # %print_back_to_string.exit810
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_176:                             # %if.end438
                                        #   in Loop: Header=BB39_1 Depth=1
...
# BB#245:                               # %if.then443
	...
	l.bf	.LBB39_182
	l.nop	0                       # in delay slot
.LBB39_181:                             # %print_back_to_string.exit801
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_182:                             # %if.end451
                                        #   in Loop: Header=BB39_1 Depth=1
...
# BB#246:                               # %while.body471
	...
	l.bf	.LBB39_192
	l.nop	0                       # in delay slot
.LBB39_193:                             # %while.end477.loopexit
                                        #   in Loop: Header=BB39_1 Depth=1
	l.lwz	r3, -108(r2)
	l.lwz	r4, -148(r2)
	l.sub	r3, r4, r3
...
# BB#247:                               # %while.end477
	...
	l.bf	.LBB39_198
	l.nop	0                       # in delay slot
.LBB39_197:                             # %print_back_to_string.exit783
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_198:                             # %do.end484
                                        #   in Loop: Header=BB39_1 Depth=1
...
# BB#248:                               # %while.body501
	...
	l.bf	.LBB39_206
	l.nop	0                       # in delay slot
.LBB39_207:                             # %while.end507.loopexit
                                        #   in Loop: Header=BB39_1 Depth=1
	l.lwz	r3, -128(r2)
	l.lwz	r4, -140(r2)
	l.sub	r3, r4, r3
...
# BB#249:                               # %while.end507
	...
	l.bf	.LBB39_212
	l.nop	0                       # in delay slot
.LBB39_211:                             # %print_back_to_string.exit765
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_212:                             # %do.end514
                                        #   in Loop: Header=BB39_1 Depth=1
...
# BB#250:                               # %if.end517
	...
	l.bf	.LBB39_217
	l.nop	0                       # in delay slot
.LBB39_216:                             # %print_back_to_string.exit756
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_217:                             # %if.end521
                                        #   in Loop: Header=BB39_1 Depth=1
...
# BB#251:                               # %while.body538
	...
	l.bf	.LBB39_225
	l.nop	0                       # in delay slot
.LBB39_226:                             # %while.end544.loopexit
                                        #   in Loop: Header=BB39_1 Depth=1
	l.lwz	r3, -108(r2)
	l.lwz	r4, -92(r2)
	l.sub	r3, r4, r3
...
# BB#252:                               # %while.end544
	...
	l.bf	.LBB39_231
	l.nop	0                       # in delay slot
.LBB39_230:                             # %print_back_to_string.exit738
	l.j	.LBB39_8
	l.nop	0                       # in delay slot
.LBB39_61:                              # %if.else131
                                        #   in Loop: Header=BB39_1 Depth=1
